...
function WeeklyOverviewView({ data, profile }) {
  ...
  const weekData = useMemo(() => {
    ...
    return { weekDates, weekStartStr, weekEndStr, eventsByDate, activeClassesByDate, finalsByDate };
  ...
  const { weekDates, weekStartStr, weekEndStr, eventsByDate, activeClassesByDate, finalsByDate } = weekData;
